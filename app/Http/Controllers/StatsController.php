...
class StatsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $dateColumn = in_array($dateField, ['order_date', 'delivery_date'], true) ? $dateField : 'order_date';
        ...
        if ($dateRange !== 'all_time') {
            ...
            $query->whereBetween($dateColumn, [$dates['start'], $dates['end']]);
        }
