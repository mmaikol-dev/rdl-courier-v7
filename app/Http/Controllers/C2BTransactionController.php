   ...
   public function confirmTransaction(Request $request)
{
    ...
    $businessShortCode = $request->input('BusinessShortCode'); // <-- capture paybill
    ...
    try {
        ...
        C2BTransaction::updateOrCreate(
            ...
            [
                ...
                'amount'         => $transAmount,
                'payer_phone'    => $businessShortCode, // store paybill here
            ]
        );
...
public function store(Request $request)
{
    $validated = $request->validate([
        ...
        'payer_phone'    => 'required|string', // still required, but now holds paybill
        'processed'      => 'boolean',
    ]);
