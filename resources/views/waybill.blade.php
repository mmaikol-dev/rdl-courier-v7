...
<body>
    ...
    <span>
        {!! DNS2D::getBarcodeHTML("$order->order_no | $order->item | $order->quantity",'QRCODE',6,6) !!}
    ...
    <article>
        ...
        <address contenteditable>
            <p>.</p>
            <p><span></span>Name: {{ $order->client_name }}</p><br>
            <p><span>Phone: </span> {{ $order->phone }}<br></p><br>
            <p><span>Date: </span> {{ $order-> delivery_date }}<br></p><br>
            <p><span>Location: </span> {{ $order->city }} | {{$order->address}}</p><br>
        </address>
        <table class="meta">
            <tr>
                <th><span contenteditable>Invoice #</span></th>
                <td><span contenteditable>RDL- {{ $order->order_no }}</span></td>
            </tr>
            <tr>
                <th><span contenteditable>Date</span></th>
                <td><span contenteditable>{{ $order-> delivery_date }}</span></td>
            </tr>
            <tr>
        ...
        <table class="inventory">
            ...
            <tbody>
                <tr>
                    <td><span contenteditable>{{ $order->product_name }}</span></td>
                    <td><span contenteditable>{{ $order->amount }}</span></td>
    ...
    Account No: {{ $order->order_no }}
        ...
        <table class="balance">
            ...
            <tr>
                ...
                <td><span data-prefix></span><span contenteditable>{{ $order->amount }}</span></td>
            </tr>
        </table>
    </article>
