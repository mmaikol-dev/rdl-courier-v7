...
import { Calendar1Icon, CopyIcon, EyeIcon, FilterIcon, MessageCircleMoreIcon, PlusIcon, RefreshCwIcon, Trash2Icon, MicIcon, MicOffIcon, Loader2 } from "lucide-react";
          ...
          <Sheet open={isCallSheetOpen} onOpenChange={setIsCallSheetOpen}>
            ...
            <SheetContent side="right" className="w-[420px] sm:w-[520px] overflow-y-auto">
              ...
              <div className="mt-4">
                <VoicePanel
                  variant="compact"
                  initialPhoneNumber={voiceDialNumber}
                  autoInitialize={isCallSheetOpen}
                />
              </div>
            </SheetContent>
          </Sheet>
