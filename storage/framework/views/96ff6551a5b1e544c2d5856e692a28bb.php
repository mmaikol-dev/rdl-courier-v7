...
<body>
    ...
    <header>
        <h1>Realdeal Logistics – Riders Sheet
        
        </h1>

        <div class="header-content">
            <div class="company-info">
                <p class="signature-label bold "><?php echo e($printDate); ?></p>
            ...
            <div class="meta-wrapper">
                <table class="meta">
                    <tr>
                        <th>Rider Signature:<?php echo e($agent); ?></th>
                        <td>_____________</td>
                    </tr>
                    <tr>
                        <th>Dispatcher Signature:_________</th>
                        <td>_____________</td>
                    </tr>
                    
                    <tr>
                        <th>Total Orders</th>
                        <td><?php echo e(count($orders)); ?> - <?php echo e($printDate); ?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <table class="inventory">
        ...
        <tbody>
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="col-order"><?php echo e($order->cc_email); ?></td>
                    <td class="col-order"><?php echo e($order->order_no); ?></td>
                    <td class="col-product"><?php echo e($order->product_name); ?></td>
                    <td class="col-qty"><?php echo e($order->quantity); ?></td>
                    <td class="col-price"><?php echo e(number_format($order->amount, 2)); ?></td>
                    <td class="col-client"><?php echo e($order->client_name); ?></td>
                    <td class="col-phone"><?php echo e($order->phone); ?></td>
...
</html><?php /**PATH /home/atlas/projects/rdlv18 (2)/rdlv10.0/resources/views/orderspdf.blade.php ENDPATH**/ ?>