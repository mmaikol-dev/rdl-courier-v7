...
<body>
    ...
    <span>
        <?php echo DNS2D::getBarcodeHTML("$order->order_no | $order->item | $order->quantity",'QRCODE',6,6); ?>
    ...
    <article>
        ...
        <address contenteditable>
            <p>.</p>
            <p><span></span>Name: <?php echo e($order->client_name); ?></p><br>
            <p><span>Phone: </span> <?php echo e($order->phone); ?><br></p><br>
            <p><span>Date: </span> <?php echo e($order-> delivery_date); ?><br></p><br>
            <p><span>Location: </span> <?php echo e($order->city); ?> | <?php echo e($order->address); ?></p><br>
        </address>
        <table class="meta">
            <tr>
                <th><span contenteditable>Invoice #</span></th>
                <td><span contenteditable>RDL- <?php echo e($order->order_no); ?></span></td>
            </tr>
            <tr>
                <th><span contenteditable>Date</span></th>
                <td><span contenteditable><?php echo e($order-> delivery_date); ?></span></td>
            </tr>
            <tr>
                <th><span contenteditable>Order No</span></th>
                <td><span contenteditable><?php echo e($order->order_no); ?></span></td>
            </tr>
        </table>
        <table class="inventory">
            ...
            <tbody>
                <tr>
                    <td><span contenteditable><?php echo e($order->product_name); ?></span></td>
                    <td><span contenteditable><?php echo e($order->amount); ?></span></td>
                    <td><span data-prefix></span><span contenteditable><?php echo e($order->quantity); ?></span></td>
                    <td><span data-prefix></span><span><?php echo e($order->amount); ?></span></td>
                </tr>
            </tbody>
        </table>
<?php
...
<?php else: ?>
    <p style="font-size: 22px; font-family: 'Poppins', sans-serif; letter-spacing: 1px;">
        PayBill No: <?php echo e($paybillNumber); ?><br>
        Account No: <?php echo e($order->order_no); ?>
...
<?php endif; ?>
        ...
        <table class="balance">
            ...
            <tr>
                ...
                <td><span data-prefix></span><span contenteditable><?php echo e($order->amount); ?></span></td>
            </tr>
        </table>
    </article>
...
<?php /**PATH /home/atlas/projects/rdlv18 (2)/rdlv10.0/resources/views/waybill.blade.php ENDPATH**/ ?>