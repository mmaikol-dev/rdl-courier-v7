    ...
    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="page">
            <header>
                ...
                <span>
                    <?php echo DNS2D::getBarcodeHTML("$order->order_no | $order->product_name | $order->quantity", 'QRCODE', 6, 6); ?>
            ...
            <article>
                ...
                <address contenteditable>
                    <p>.</p>
                    <p>Name: <?php echo e($order->client_name); ?></p><br>
                    <p>Phone: <?php echo e($order->phone); ?></p><br>
                    <p>Date: <?php echo e($order->delivery_date); ?></p><br>
                    <p>Location: <?php echo e($order->city); ?> | <?php echo e($order->address); ?></p><br>
                </address>
    
                <table class="meta">
                    <tr>
                        <th>Invoice #</th>
                        <td>RDL-<?php echo e($order->order_no); ?></td>
                    </tr>
                    <tr>
                        <th>Date</th>
...
<?php /**PATH /home/atlas/projects/rdlv18 (2)/rdlv10.0/resources/views/waybills.blade.php ENDPATH**/ ?>